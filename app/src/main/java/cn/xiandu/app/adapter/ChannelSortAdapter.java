...
import cn.xiandu.app.utils.OnDragVHListener;
import cn.xiandu.app.utils.OnItemMoveListener;
 ...
 */
public class ChannelSortAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    // 我的频道 标题部分
    ...
    public ChannelSortAdapter(Context context, ItemTouchHelper helper, List<ChannelBean> mMyChannelItems, List<ChannelBean> mOtherChannelItems) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            String channel = mMyChannelItems.get(position - COUNT_PRE_MY_HEADER).getName();
            myHolder.textView.setText(channel.substring(0,channel.length() - 2));
            myHolder.textView.setTextColor(context.getResources().getColor(ThemeManager.getCurrentThemeRes(context, R.color.color_666666)));
            if (isEditMode) {
            ...
            String channel = mOtherChannelItems.get(position - mMyChannelItems.size() - COUNT_PRE_OTHER_HEADER).getName();
            ((OtherViewHolder) holder).textView.setText(channel.substring(0,channel.length() - 2));
            ((OtherViewHolder) holder).textView.setTextColor(context.getResources().getColor(ThemeManager.getCurrentThemeRes(context, R.color.color_666666)));
