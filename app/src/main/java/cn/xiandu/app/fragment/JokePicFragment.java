...
import cn.xiandu.app.adapter.JokePicAdapter;
 ...
 * {@link JokePicFragment} interface
 * to handle interaction events.
 */
public class JokePicFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private List<JokePicBean> list = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_pic_joke, container, false);
            ButterKnife.bind(this, view);
            gson = new Gson();
            mAdapter = new JokePicAdapter(getActivity(),R.layout.home_item_layout, list);
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if (code == 0) {
                                ...
                                Type t = new TypeToken<List<JokePicBean>>() {
                                }.getType();
                                List<JokePicBean> ls = gson.fromJson(ja.toString(), t);
                                Logger.d(ls.get(0));
                                mAdapter.addData(ls);
                                pageCode++;
                            } else {
